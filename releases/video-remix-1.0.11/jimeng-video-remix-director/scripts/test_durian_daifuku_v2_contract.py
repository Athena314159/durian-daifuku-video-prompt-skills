...
def main() -> int:
    with tempfile.TemporaryDirectory() as temporary:
        ...
        assert not active_legacy_contamination(migrated, "video-remix-1.0.11")
        ...
        assert migrated_v2_project["skill_release_lock"]["bundle_release_id"] == "video-remix-1.0.11"
        ...
        assert intake["skill_release"] == "video-remix-1.0.11"
        ...
        assert reuse["contract_binding"]["bundle_release_id"] == "video-remix-1.0.11"
        assert not active_legacy_contamination(migrated_v2, "video-remix-1.0.11")
        ...
        findings = active_legacy_contamination(migrated_v2, "video-remix-1.0.11")
