...
def prepare(args: argparse.Namespace) -> dict[str, Any]:
    ...
    anchor_width = float(args.anchor_width_px)
    if anchor_width <= 0:
    ...
    write_json(report_path, {"schema_version": "daifuku-pixel-preflight-v1.0", **pixel_plan})
...
def main() -> int:
    ...
    parser.add_argument("--anchor-width-px", required=True, type=float)
